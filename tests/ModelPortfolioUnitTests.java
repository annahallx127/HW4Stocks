...
//    double expectedValue3 = (3 * 190.9000);
  ...
  public void testReBalancePortfolio() {
    portfolio.add(stock1, 4, "2024-10-13"); //178.8500 --> 715.4
    portfolio.add(stock2, 3, "2024-10-13"); //138.5800 --> 415.74
    //total: 1,131.13
    ...
    portfolioAfterReBalance.add(stock1, 1.45741638, "2024-06-03");
    ...
    // and comparing the total value of the portfolio at that date is the same
  }

  @Test
  public void testGetValueDistribution2() {
