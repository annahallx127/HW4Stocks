...
////    StringReader inContent = new StringReader("4\nMyPortfolio\nAAPL\n10\nno\n6\n");
////    controller = new ControllerImpl(inContent, outContent);
////    controller.runController();
//////    simulateUserInput("4\nMyPortfolio\nAAPL\n10\nno\n6\n");
//////    new ViewImpl(controller);
////
////    Portfolio portfolio = controller.getPortfolios().get("MyPortfolio");
...
//////    simulateUserInput("1\nAAPL\n2021-01-01\n2021-01-31\n6\n");
////    StringReader inContent = new StringReader("1\nAAPL\n2021-01-01\n2021-01-31\n6\n");
////    controller = new ControllerImpl(inContent, outContent);
////    controller.controllerGo();
//////    new ViewImpl(controller);
...
//    StringReader inContent = new StringReader(("5\n1\n6\n"));
//    controller = new ControllerImpl(inContent, outContent);
////    controller.runController();
////    simulateUserInput("5\n1\n6\n");
...
//////    simulateUserInput("2\nAAPL\n10\n2021-01-01\n6\n");
////    StringReader inContent = new StringReader(("2\nAAPL\n10\n2021-01-01\n6\n"));
////    controller = new ControllerImpl(inContent, outContent);
////    controller.controllerGo();
//////    new ViewImpl(controller);
...
//////    simulateUserInput("3\nAAPL\n10\n2021-01-01\n2021-01-31\n6\n");
////    StringReader inContent = new StringReader(("3\nAAPL\n10\n2021-01-01\n2021-01-31\n6\n"));
////    controller = new ControllerImpl(inContent, outContent);
////    controller.controllerGo();
//////    new ViewImpl(controller);
